...
//  Serial.println("");
  ...
  //Serial.println("Starting buffer stuff");
  uint8_t buffer[31];    
  uint16_t sum = 0;
  s->readBytes(buffer, 31);
//  Serial.println("buffer one:");
//  for (uint8_t i=0; i<31; i++) {
//    Serial.print("0x"); Serial.print(buffer[i], HEX); Serial.print(", ");
//  }
//  Serial.println("");
  uint8_t bufferTwo[32];
//  Serial.println("buffer two:");
//  for (uint8_t i=0; i<32; i++) {
//    Serial.print("0x"); Serial.print(bufferTwo[i], HEX); Serial.print(", ");
//  }
//  Serial.println("");
  bufferTwo[0] = first;
  for (uint8_t i=0; i<31; i++) {
...
//  Serial.println("");
//  Serial.println("finished buffer two:");
//  for (uint8_t i=0; i<32; i++) {
//    Serial.print("0x"); Serial.print(bufferTwo[i], HEX); Serial.print(", ");
//  }
//  Serial.println("");
//  Serial.println("Done buffer stuff");
//  Serial.println("");
   //get checksum ready
