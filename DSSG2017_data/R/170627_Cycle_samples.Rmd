...
mapPoints <- ggmap(map) +geom_point(aes(x = lon, y = lat, colour=way), data = gps[340:345,], alpha = 0.8, size = 0.5)
mapPoints
...
mapPoints <- ggmap(map) +geom_point(aes(x = lon, y = lat, color="red"), data = gps[200:300,], alpha = 0.8, size = 0.5)
mapPoints
