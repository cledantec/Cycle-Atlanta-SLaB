...
# Car signature (Lidar Frequency-domain Feature + Sonar Freq-domain Feature)
...
human <- generate_left_signature(human)
parallel <- generate_left_signature(parallel)
tree <- generate_left_signature(tree)
car_block <- generate_left_signature(car_block)
wall <- generate_left_signature(wall)
