#This code reads data off the 4 sensors and then sends it out via a LAN Cable connected to the Raspberry Pi
...
GPIO.output(ERROR_PIN,True)                                                     # Make it alive only if loop 
